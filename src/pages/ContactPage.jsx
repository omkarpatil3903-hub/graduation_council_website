...
const contactValues = [
  {
    value: "council@graduatecouncil.org",
    href: "mailto:council@graduatecouncil.org",
  },
          ...
          <div className="grid gap-4 sm:gap-5">
            {contactLabels.map((label, idx) => {
              ...
              return (
                <article
                  key={label}
                  className="animate-on-scroll flex items-start gap-4 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm"
                >
                  ...
                  <div>
                    ...
                    {info.href ? (
                      <a
                        href={info.href}
                        className="mt-1 block text-sm font-medium text-slate-800 hover:text-primary-600"
                      >
                        {info.value}
                      </a>
                    ) : (
